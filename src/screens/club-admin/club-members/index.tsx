...
import { ScreenHeader, SearchBar, TabBar, FilterModal } from '../../../shared/components';
...
const ClubMembersScreen = (): React.JSX.Element => {
  ...
  const { user } = useAuth();
  const { members, balances, refreshing, loadData, onRefresh } = useClubMembers(user?.clubId);
