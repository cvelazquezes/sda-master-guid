...
export const MESSAGES = {
  ...
  ERRORS: {
    ...
    INVALID_WHATSAPP: 'Please enter a valid WhatsApp number with country code (e.g., +1 555 123 4567)',
  ...
  WARNINGS: {
    ...
    CONFIRM_RESET_MEETING: 'Are you sure you want to reset to the default template? All current changes will be lost.',
    ...
    CONFIRM_GENERATE_MATCHES: 'This will generate new social activity matches for all club members. Continue?',
    NOTIFY_PARTICIPANTS_MESSAGE: 'Send WhatsApp notifications to all participants about this match?',
    MEMBER_ALREADY_IN_POSITION: 'This member is already assigned to a position. Please remove them first before assigning to a new position.',
...
export const dynamicMessages = {
  confirmDeleteMember: (memberName: string) => 
    `Are you sure you want to delete ${memberName}?`,
  confirmApproveMember: (memberName: string) => 
    `Approve ${memberName} to join the club?`,
  confirmRejectMember: (memberName: string) => 
    `Reject ${memberName}'s application? This cannot be undone.`,
  memberApproved: (memberName: string) => 
    `${memberName} has been approved!`,
  memberRejected: (memberName: string) => 
    `${memberName}'s application has been rejected`,
  confirmDeleteClub: (clubName: string) => 
  ...
  organizationDeleted: (typeName: string) => 
