 ...
 */
export function useTokenColors(): ReturnType<typeof useDesignTokens>['colors'] {
 ...
 */
export function useTokenSpacing(): ReturnType<typeof useDesignTokens>['semantic']['spacing'] {
 ...
 */
export function useTokenTypography(): ReturnType<typeof useDesignTokens>['semantic']['typography'] {
  const { semantic } = useDesignTokens();
 ...
 */
export function useTokenComponents(): ReturnType<typeof useDesignTokens>['components'] {
 ...
 */
export function useTokenMotion(): typeof motionTokens {
  return motionTokens;
}
 ...
 */
export function useTokenPrimitives(): typeof primitiveTokens {
 ...
 */
export function useTokenLayout(): typeof layoutTokens {
  return layoutTokens;
}
 ...
 */
export function useTokenBehavior(): typeof behaviorTokens {
...
export function useResponsiveLayout(): {
  ...
  isTablet: boolean;
  isDesktop: boolean;
  density: ReturnType<typeof getResponsiveDensity>;
  breakpoints: typeof layoutTokens.breakpoints;
} {
...
export function useDensity(
  overrideDensity?: DensityMode
): (typeof layoutTokens.density)[DensityMode] {
